...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kpz", 0.5)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdz", 0.3)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "z_int_low", 0)
    ...
    try:
        while True:
            ...
            # fx_ave
            serial.send_control_params(ROBOT_MAC, (ready, 0, fz, tx, tz, led, 0, 0, 0, 0, 0, 0, 0))
            time.sleep(dt)
